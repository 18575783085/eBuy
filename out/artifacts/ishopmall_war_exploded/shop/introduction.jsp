...
<<html>
	...
	<%@include file="../../../shop/_head2.jsp"%>
            ...
            <b class="line" style="height: 23px"></b>
			<div class="listMain">
				...
				<div class="scoll">
					<section class="slider">
						<div class="flexslider">
							<ul class="slides">
								<li>
									<img src="${appPath}/images/01.jpg" title="pic" />
								</li>
								<li>
									<img src="${appPath}/images/02.jpg" />
								</li>
								<li>
									<img src="${appPath}/images/03.jpg" />
								</li>
							</ul>
						</div>
					</section>
					...
					<div class="clearfixLeft" id="clearcontent">
						...
						<div class="box">
							...
							<div class="tb-booth tb-pic tb-s310">
								<a href="${appPath}/images/01.jpg"><img src="${appPath}/images/01_mid.jpg" alt="细节展示放大镜特效" rel="${appPath}/images/01.jpg" class="jqzoom" /></a>
							</div>
							<ul class="tb-thumb" id="thumblist">
								<li class="tb-selected">
									<div class="tb-pic tb-s40">
										<a href="#"><img src="${appPath}/images/01_small.jpg" mid="${appPath}/images/01_mid.jpg" big="${appPath}/images/01.jpg"></a>
									</div>
								</li>
								<li>
									<div class="tb-pic tb-s40">
										<a href="#"><img src="${appPath}/images/02_small.jpg" mid="${appPath}/images/02_mid.jpg" big="${appPath}/images/02.jpg"></a>
									</div>
								</li>
								<li>
									<div class="tb-pic tb-s40">
										<a href="#"><img src="${appPath}/images/03_small.jpg" mid="${appPath}/images/03_mid.jpg" big="${appPath}/images/03.jpg"></a>
									</div>
								</li>
							</ul>
						</div>
						...
						<div class="tb-detail-list">
							...
							<div class="shopPromotion gold">
								<div class="hot">
									...
									<div class="gold-list">
										<p>这个商品简短的介绍<span>权益保障<i class="am-icon-sort-down"></i></span></p>
									</div>
								</div>
								<div class="clear"></div>
								<div class="coupon">
					    ...
					    <div class="mc"> 
						     <ul>					    
						     	<div class="mt">            
							      ...
							      <li class="first">
							      	<div class="p-img">                    
							      		<a  href="#"> <img class="" src="${appPath}/images/browse1.jpg"> </a>               
							      	</div>
								...
								<div class="am-tab-panel am-fade am-in am-active">
									...
									<div class="details">
										...
										<div class="twlistNews">
											<img src="${appPath}/images/tw1.jpg" />
											<img src="${appPath}/images/tw2.jpg" />
											<img src="${appPath}/images/tw3.jpg" />
											<img src="${appPath}/images/tw4.jpg" />
											<img src="${appPath}/images/tw5.jpg" />
											<img src="${appPath}/images/tw6.jpg" />
											<img src="${appPath}/images/tw7.jpg" />
										</div>
									</div>
									<div class="clear"></div>
										...
										<ul class="am-avg-sm-2 am-avg-md-3 am-avg-lg-4 boxes">
											<li>
												<div class="i-pic limit">
													<img src="${appPath}/images/imgsearch1.jpg" />
