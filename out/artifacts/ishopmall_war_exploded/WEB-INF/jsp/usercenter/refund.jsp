...
<html>
	...
	<head>
		...
		<link href="${appPath}/css/refstyle.css" rel="stylesheet" type="text/css">
						...
						<div class="refund-aside">
							<div class="item-pic">
								<a href="#" class="J_MakePoint">
									<img src="${appPath}/images/comment.jpg_400x400.jpg" class="itempic">
								</a>
							</div>
						...
						<div class="refund-main">
							...
							<div class="refund-tip">
								<div class="filePic">
									...
									<img src="${appPath}/images/image.jpg" alt="">
								</div>
