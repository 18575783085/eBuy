...
<html>
	...
	<body>
						...
						<div class="wrap-list">
							<div class="m-user">
								...
								<div class="m-userinfo">
									<a href="${appPath}/usercenter/news">
										<div class="tipsBox"><i class="am-icon-envelope"></i></div>
									</a>
									<div class="m-baseinfo">
										<a class="m-pic" href="${appPath }/usercenter/information">
											<img src="${appPath}/images/getAvatar.do.jpg">
										</a>
										<div class="m-info">
											<em class="s-name">${sessionScope.User.userName}</em>
											<div class="vip1"><a href="#"><span></span><em>会员专享</em></a></div>
											<div class="safeText"><a href="${appPath}/usercenter/safety">账户安全:<em style="margin-left:20px ;">60</em>分</a>
												<div class="progressBar"><span style="left: -95px;" class="progress"></span></div>
											</div>
											<div class="m-address">
												<a href="${appPath}/usercenter/address" class="i-trigger">收货地址<i class="am-icon-angle-right" style="padding-left:5px ;"></i></a>
											</div>
										</div>
									</div>
									<div class="m-right">
										<div class="m-new">
											<a href="${appPath}/usercenter/news"><i class="am-icon-dropbox  am-icon-md" style="padding-right:5px ;"></i>消息盒子</a>
										</div>
								...
								<div class="m-userproperty">
									...
									<p class="m-coupon">
										<a href="${appPath}/WEB-INF/jsp/userCenter/coupon.jsp">
											<em class="m-num">0</em>
											<span class="m-title">优惠券</span>
										</a>
									</p>
									<p class="m-wallet">
										<a href="${appPath}/WEB-INF/jsp/userCenter/wallet.jsp">
											<em class="m-num">0.00</em>
											<span class="m-title">账户余额</span>
										</a>
									</p>
									<p class="m-bill">
										<a href="${appPath}/WEB-INF/jsp/userCenter/pointnew.jsp">
								...
								<div class="wallet">
									...
									<p class="m-big squareS">
										<a href="#">
											<i><img src="${appPath}/images/shopping.png"/></i>
											<span class="m-title">能购物</span>
										</a>
									</p>
									<p class="m-big squareA">
										<a href="#">
											<i><img src="${appPath}/images/safe.png"/></i>
											<span class="m-title">够安全</span>
										</a>
									</p>
									<p class="m-big squareL">
										<a href="#">
											<i><img src="${appPath}/images/profit.png"/></i>
							...
							<div class="m-order">
								<div class="s-bar">
									...
									<a class="i-load-more-item-shadow" href="${appPath}/WEB-INF/jsp/userCenter/order.jsp">全部订单</a>
								</div>
								<ul>
									<li><a href="${appPath}/WEB-INF/jsp/userCenter/order.jsp"><i><img src="${appPath}/images/pay.png"/></i><span>待付款</span></a></li>
									<li><a href="${appPath}/WEB-INF/jsp/userCenter/order.jsp"><i><img src="${appPath}/images/send.png"/></i><span>待发货<em class="m-num">1</em></span></a></li>
									<li><a href="${appPath}/WEB-INF/jsp/userCenter/order.jsp"><i><img src="${appPath}/images/receive.png"/></i><span>待收货</span></a></li>
									<li><a href="${appPath}/WEB-INF/jsp/userCenter/order.jsp"><i><img src="${appPath}/images/comment.png"/></i><span>待评价<em class="m-num">3</em></span></a></li>
									<li><a href="${appPath}/WEB-INF/jsp/userCenter/change.jsp"><i><img src="${appPath}/images/refund.png"/></i><span>退换货</span></a></li>
								</ul>
							...
							<div class="user-squaredIcon">
								...
								<ul>
									<a href="${appPath}/WEB-INF/jsp/userCenter/order.jsp">
										<li class="am-u-sm-4"><i class="am-icon-truck am-icon-md"></i>
											<p>物流查询</p>
										</li>
									</a>
									<a href="${appPath}/WEB-INF/jsp/userCenter/collection.jsp">
										<li class="am-u-sm-4"><i class="am-icon-heart am-icon-md"></i>
											<p>我的收藏</p>
										</li>
									</a>
									<a href="${appPath}/WEB-INF/jsp/userCenter/foot.jsp">
									...
									<a href="${appPath}/WEB-INF/jsp/shop/blog.jsp">
							...
							<div class="user-suggestion">
								...
								<div class="s-bar">
									<a href="${appPath}/WEB-INF/jsp/userCenter/suggest.jsp"><i class="s-icon"></i>意见反馈</a>
								</div>
							</div>
								...
								<div class="twoTabModel credit">
									...
									<div class="Box">
										...
										<div class="am-slider am-slider-default am-slider-carousel" data-am-flexslider="{itemWidth:108, itemMargin:3, slideshow: false}">
											<ul class="am-slides">
												<li><a href="#"><img src="${appPath}/images/333.jpg" /></a></li>
												<li><a href="#"><img src="${appPath}/images/222.jpg" /></a></li>
												<li><a href="#"><img src="${appPath}/images/111.jpg" /></a></li>
												<li><a href="#"><img src="${appPath}/images/333.jpg" /></a></li>
												<li><a href="#"><img src="${appPath}/images/222.jpg" /></a></li>
												<li><a href="#"><img src="${appPath}/images/111.jpg" /></a></li>
											</ul>
							...
							<div class="new-goods-info">
								<a class="shop-info" href="#">
									<div class="face-img-panel">
										<img src="${appPath}/images/imgsearch1.jpg" alt="">
									</div>
                        ...
                        <div class="am-tabs-bd">
                            ...
                            <div data-tab-panel-0 class="am-tab-panel am-active">
                        		<div class="am-slider am-slider-default am-slider-carousel" data-am-flexslider="{itemWidth:155,slideshow: false}">
									<ul class="am-slides">
                                       <li>
                                       	  <a><img class="am-thumbnail" src="${appPath}/images/EZA27501.jpg" /></a>
                                       	  <strong class="price">¥32.9</strong>
                                       </li>
                                       <li>
                                       	  <a><img class="am-thumbnail" src="${appPath}/images/BxJk6.jpg" /></a>
                                       	  <strong class="price">¥32.9</strong>
                                       </li>
                                       <li>
                                       	  <a><img class="am-thumbnail" src="${appPath}/images/Hxcag60.jpg" /></a>
                                       	  <strong class="price">¥32.9</strong>
                                       </li>
                                       <li>
                                       	  <a><img class="am-thumbnail" src="${appPath}/images/youzi.jpg" /></a>
                                       	  <strong class="price">¥32.9</strong>
                                       </li>
                                       <li>
                                       	  <a><img class="am-thumbnail" src="${appPath}/images/EZA27501.jpg" /></a>
		...
		<!--引导 -->
<%-- 		<div class="navCir">
			<li><a href="${appPath}/home/home2.jsp"><i class="am-icon-home "></i>首页</a></li>
			<li><a href="${appPath}/home/sort.jsp"><i class="am-icon-list"></i>分类</a></li>
			<li><a href="${appPath}/home/shopcart.jsp"><i class="am-icon-shopping-basket"></i>购物车</a></li>
			<li class="active"><a href="${appPath}/index.jsp"><i class="am-icon-user"></i>我的</a></li>
		</div> --%>
