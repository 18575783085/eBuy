					...
					<div class="user-orderinfo">
						...
						<div class="order-infoaside">
							<div class="order-logistics">
								<a href="${appPath}/logistics.jsp">
									<div class="icon-log">
										<i><img src="${appPath}/images/receive.png"></i>
									</div>
									<div class="latest-logistics">
										...
										<div class="inquire">
											...
											<a href="${appPath}/logistics.jsp">查看</a>
										</div>
									</div>
											...
											<div class="move-right">
												<li class="td td-status">
													<div class="item-status">
														...
														<p class="order-info"><a href="${appPath}/logistics.jsp">查看物流</a></p>
