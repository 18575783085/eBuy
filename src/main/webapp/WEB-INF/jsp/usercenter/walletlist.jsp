...
<html>
	...
	<head>
		...
		<link href="${appPath}/css/wallet.css" rel="stylesheet" type="text/css">
			...
			<div class="col-main">
				<div class="main-wrap">
					<div class="am-cf am-padding">
						<div class="am-fl am-cf"><strong class="am-text-danger am-text-lg">账户明细</strong> / <small>Electronic&nbsp;bill</small></div>
					</div>
					<hr>
					<div class="finance">
						<div class="financeText">
							...
							<a href="${appPath}/WEB-INF/jsp/userCenter/safety.jsp">安全中心：保护账户资产安全</a>
						</div>
					</div>
